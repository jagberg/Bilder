---
title: Electrical Plan and Home Automation
description: Guide to electrical planning for new home construction — lighting, power points, circuits, home automation, security, and pricing.
...
| LED Strip Lights (single kitchen run) – with dots (not incl. kitchen cabinet recess cost) | $385 |
| LED Strip Lights (single kitchen run) – with no dots (not incl. kitchen cabinet recess cost) | $485 |
...
| Switch to a GPO | $85 |
| Isolation switch double pole (for induction cooktop) | $73 |
...
| 1 x 25mm conduit run from Meter box to roof space for Solar provision | $300 |
...
| Item | Price |
|------|-------|
| Projector Provision – 1 x 40mm conduit from D/GPO to TV Point fitted with a Bullnose plate set and draw string | $350 |
...
[Lighting basics and a broad view](https://www.facebook.com/709881115/videos/10157354090026116/)
